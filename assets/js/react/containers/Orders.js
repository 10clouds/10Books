...
// TODO: Move colums to separate components
      ...
      <Provider store={this.props.store}>
        <div>
          ...
          <ProductsTableContainer
            renderNoResults={() => (
              <div className="text-center">No orders yet :( <b>Be the first one!</b></div>
            )}
            appendColumns={[
              {
                title: "Requested by",
              ...
              },
              {
                ...
                render: (product, tableProps) => (
                  this.props.user.is_admin ? (
                    <StatusSelect
                      value={product.status}
                      onChange={val => (
                        tableProps.onChange(product.id, { status: val })
                      )}
                    />
                  ) : (
                    ...
                    product.requested_by.id === this.props.user.id ? (
                      <button
                        ...
                        onClick={() => {
                          tableProps.onChange(product.id, { status: "DELETED" })
                        }}
                      >
