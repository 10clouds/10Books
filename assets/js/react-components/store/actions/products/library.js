...
export const returnProduct = id => (dispatch, getState) => {
  ...
  return new Promise((resolve, reject) => {
    getState()
      .products.channel.push('return', { id })
      .receive('ok', resolve)
      .receive('error', reject)
  })
}
...
export const subscribeToReturnNotification = id => (dispatch, getState) => {
  ...
  return new Promise((resolve, reject) => {
    getState()
      .products.channel.push('subscribe_to_return_notification', { id })
      .receive('ok', resolve)
      .receive('error', reject)
  })
}
...
export const unsubscribeFromReturnNotification = id => (dispatch, getState) => {
  ...
  return new Promise((resolve, reject) => {
    getState()
      .products.channel.push('unsubscribe_from_return_notification', { id })
      .receive('ok', resolve)
      .receive('error', reject)
  })
}
...
export const rateProduct = (id, value) => (dispatch, getState) => {
  ...
  return new Promise((resolve, reject) => {
    getState()
      .products.channel.push('rate', { id, value })
      .receive('ok', resolve)
      .receive('error', reject)
  })
}
