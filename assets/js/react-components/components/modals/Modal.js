...
function ModalTransition({ children, ...props }) {
  return (
    <Transition {...props} timeout={TRANSITION_TIME}>
      {(status, innerProps) =>
...
export default class Modal extends PureComponent {
  ...
  handleExited() {
    document.getElementById('js-page-header').setAttribute('style', null)
  }
      ...
      >
        ...
        >
          <div className="modal__content">
            <button className="modal__close" onClick={this.props.onHide}>
              Close
            </button>
            {this.props.children}
          </div>
