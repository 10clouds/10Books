...
export default class TableRow extends PureComponent {
  ...
  renderAppendColumn(colProps, key) {
    ...
    const { modifiers, className, ...restElProps } = elProps || {}
  ...
  render() {
    ...
    return (
      ...
      >
        <SectionWrapper
          enabled={canToggleDetails}
          className="table__row-header"
        >
          ...
          <div className="table__col table__col--author">{product.author}</div>
        </SectionWrapper>
