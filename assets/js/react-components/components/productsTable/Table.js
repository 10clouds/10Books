    ...
    return (
      ...
      >
        <div className="table__row table__row--header">
          <div className="table__col table__col--title">Title</div>
          <div className="table__col table__col--author">Author</div>
          <div className="table__col table__col--category">Category</div>
